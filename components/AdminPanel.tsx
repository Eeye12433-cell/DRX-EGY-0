...
const AdminPanel: React.FC<AdminPanelProps> = ({
  ...
  const deleteProduct = async (p: Product) => {
    ...
    try {
      ...
      const {
        error
      } = key.column === 'id' ? await q.eq('id', key.value) : await q.eq('slug', key.value);
      if (error) {
                ...
                <div className="p-8">
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button onClick={() => deleteProduct(p)} className="text-[10px] font-mono font-bold uppercase text-muted hover:text-red-500 underline decoration-red-500/30 underline-offset-4 tracking-mega transition-colors">
                        Delete
                      </button>
                    </div>
                  </div>
