...
const Calculator: React.FC<CalculatorProps> = ({
  ...
  return <div className="max-w-6xl mx-auto py-10 space-y-12">
      <div className="bg-[#111] border border-white/5 p-10 lg:p-16 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
           <div className="space-y-10">
              ...
              <p className="font-mono text-xs uppercase tracking-widest leading-relaxed text-popover text-right">
                {lang === 'ar' ? 'أدخل بياناتك الحيوية للمزامنة مع مصفوفة DRX والحصول على بروتوكولات غذائية بمستوى صيدلاني.' : 'Enter your current biometrics to synchronize with the DRX Matrix and receive pharmaceutical-grade nutritional protocols.'}
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="number" className="w-full bg-black border border-white/10 p-5 font-mono text-lg outline-none focus:border-drxred transition-all" value={profile.age} onChange={e => setProfile({
                  ...profile,
                  age: +e.target.value
                })} />
                  </div>
                  <div className="space-y-2">
                    ...
                    <select className="w-full bg-black border border-white/10 p-5 font-mono text-sm outline-none focus:border-drxred h-[66px] appearance-none" value={profile.gender} onChange={e => setProfile({
                  ...profile,
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input type="number" className="w-full bg-black border border-white/10 p-5 font-mono text-lg outline-none focus:border-drxred" value={profile.weight} onChange={e => setProfile({
                  ...profile,
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="number" className="w-full bg-black border border-white/10 p-5 font-mono text-lg outline-none focus:border-drxred" value={profile.height} onChange={e => setProfile({
                  ...profile,
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full bg-black border border-white/10 p-5 font-mono text-sm outline-none focus:border-drxred appearance-none" value={profile.activity} onChange={e => setProfile({
                ...profile,
                activity: e.target.value
              })}>
                    {ACTIVITY_LEVELS.map(a => <option key={a.id} value={a.id}>{lang === 'ar' ? a.label_ar : a.label_en}</option>)}
                  </select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {GOALS.map(g => <button key={g.id} type="button" onClick={() => setProfile({
                  ...profile,
                  goal: g.id
          ...
          {!result && !loading && !aiError && <div className="text-center relative z-10 space-y-6">
                   ...
                   <p className="text-xs font-mono uppercase tracking-[0.5em] text-white">Awaiting Input Sequence</p>
                </div>}

              {loading && <NutritionSkeleton />}

              {aiError && !loading && <ErrorState title="Analysis Failed" message={aiError} onRetry={() => {
            setAiError(null);
          }} variant="card" />}

              {result && <div className="w-full space-y-8 relative z-10 result-anim">
                   <div className="bg-black/80 backdrop-blur-md border border-drxred/40 p-12 shadow-[0_0_50px_rgba(225,29,72,0.1)]">
                      ...
                      <div className="grid grid-cols-3 gap-8 mt-14 border-t border-white/5 pt-12">
                         <div className="text-center group">
                            ...
                            <div className="h-1.5 bg-white/5 mt-4"><div className="h-full bg-drxred" style={{
                      width: '85%'
                    }}></div></div>
                         </div>
                         <div className="text-center group">
                            ...
                            <div className="h-1.5 bg-white/5 mt-4"><div className="h-full bg-blue-500" style={{
                      width: '60%'
                    }}></div></div>
                         </div>
                         <div className="text-center group">
                            ...
                            <div className="h-1.5 bg-white/5 mt-4"><div className="h-full bg-yellow-500" style={{
                      width: '40%'
                    }}></div></div>
                         </div>
                      </div>
      ...
      {result && <div className="grid grid-cols-1 md:grid-cols-2 gap-12 result-anim">
           <div className="bg-[#0a0a0a] border border-white/5 p-12 space-y-8">
              ...
              <div className="space-y-5">
                 {result.recommendations.map((rec, i) => <div key={i} className="flex gap-5 items-start bg-black/40 p-6 border-l-4 border-drxred/40 hover:border-drxred transition-all">
