...
const Home: React.FC<HomeProps> = ({ lang }) => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(hudRef.current, { opacity: 0, x: -50 });
  ...
  return (
    <div className="-mt-24" ref={heroRef}>
      {/* HERO SECTION */}
        ...
        <div className="container relative z-10 px-6 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-12 h-full">
          ...
          <div className="flex-shrink-0 lg:flex-1 flex justify-center lg:justify-start">
            <img 
              ...
              src={drxLogo} 
              alt="DRX Logo"
              className="w-[300px] md:w-[450px] lg:w-[550px] h-auto object-contain drop-shadow-[0_0_40px_rgba(225,29,72,0.3)]"
            />
          </div>
          ...
          <div className="flex-1 max-w-2xl">
            ...
            <h1 
              ref={titleRef}
              className="text-6xl md:text-8xl lg:text-[9rem] font-black font-oswald text-white uppercase leading-[0.85] tracking-tighter mb-12"
            >
              <span className="block text-drxred">{lang === 'ar' ? 'أداء' : 'German'}</span>
            ...
            <div ref={ctaRef} className="flex gap-6 flex-wrap">
              <button 
                ...
                className="group relative bg-drxred text-white px-12 py-6 font-black uppercase tracking-[0.3em] overflow-hidden btn-drx text-sm"
              >
              ...
              <button 
                ...
                className="group relative bg-transparent border-2 border-zinc-600 text-white px-12 py-6 font-black uppercase tracking-[0.3em] overflow-hidden btn-drx text-sm hover:border-drxred"
              >
